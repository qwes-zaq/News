...
namespace News.Core.Domain.Migrations
{
    ...
    [Migration("20220513072253_UserPropertyAdding")]
    partial class UserPropertyAdding
    {
            ...
            modelBuilder.Entity("News.Core.Domain.Models.Post", b =>
                {
                    ...
                    b.HasOne("News.Core.Domain.Models.PinnedPost", "PinnedPost")
                        .WithOne("Post")
                        .HasForeignKey("News.Core.Domain.Models.Post", "PinnedPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
